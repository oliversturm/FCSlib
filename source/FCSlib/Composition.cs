...
namespace FCSlib {
  public static partial class Functional {
    ...
    public static Func<T1, T2, T3, T4, TEndResult>
      Compose<T1, T2, T3, T4, TIntermediateResult, TEndResult>(
        Func<T1, T2, T3, T4, TIntermediateResult> func1,
        Func<TIntermediateResult, TEndResult> func2) {
      return (p1, p2, p3, p4) => func2(func1(p1, p2, p3, p4));
    }

    public static Func<T1, T2, T3, T4, T5, TEndResult>
      Compose<T1, T2, T3, T4, T5, TIntermediateResult, TEndResult>(
        Func<T1, T2, T3, T4, T5, TIntermediateResult> func1,
        Func<TIntermediateResult, TEndResult> func2) {
      return (p1, p2, p3, p4, p5) => func2(func1(p1, p2, p3, p4, p5));
    }

    public static Func<T1, T2, T3, T4, T5, T6, TEndResult> Compose<T1, T2, T3, T4, T5, T6,
      TIntermediateResult, TEndResult>(Func<T1, T2, T3, T4, T5, T6, TIntermediateResult> func1,
      Func<TIntermediateResult, TEndResult> func2) {
    ...
    public static Func<T1, T2, T3, T4, T5, T6, T7, TEndResult> Compose<T1, T2, T3, T4, T5, T6, T7,
      TIntermediateResult, TEndResult>(Func<T1, T2, T3, T4, T5, T6, T7, TIntermediateResult> func1,
      Func<TIntermediateResult, TEndResult> func2) {
      return (p1, p2, p3, p4, p5, p6, p7) => func2(func1(p1, p2, p3, p4, p5, p6, p7));
    }

    public static Func<T1, T2, T3, T4, T5, T6, T7, T8, TEndResult> Compose<T1, T2, T3, T4, T5, T6,
      T7, T8, TIntermediateResult, TEndResult>(
      Func<T1, T2, T3, T4, T5, T6, T7, T8, TIntermediateResult> func1,
      Func<TIntermediateResult, TEndResult> func2) {
      return (p1, p2, p3, p4, p5, p6, p7, p8) => func2(func1(p1, p2, p3, p4, p5, p6, p7, p8));
    }

    public static Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TEndResult> Compose<T1, T2, T3, T4, T5,
      T6, T7, T8, T9, TIntermediateResult, TEndResult>(
      Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TIntermediateResult> func1,
      Func<TIntermediateResult, TEndResult> func2) {
      return (p1, p2, p3, p4, p5, p6, p7, p8, p9) =>
        func2(func1(p1, p2, p3, p4, p5, p6, p7, p8, p9));
    }
    ...
    public static Func<T1, T2, T3, T4, T5, TEndResult>
      Compose<T1, T2, T3, T4, T5, TIR1, TIR2, TEndResult>(Func<T1, T2, T3, T4, T5, TIR1> func1,
        Func<TIR1, TIR2> func2, Func<TIR2, TEndResult> func3) {
      return (p1, p2, p3, p4, p5) => func3(func2(func1(p1, p2, p3, p4, p5)));
    }

    public static Func<T1, T2, T3, T4, T5, T6, TEndResult>
      Compose<T1, T2, T3, T4, T5, T6, TIR1, TIR2, TEndResult>(
        Func<T1, T2, T3, T4, T5, T6, TIR1> func1, Func<TIR1, TIR2> func2,
        Func<TIR2, TEndResult> func3) {
      return (p1, p2, p3, p4, p5, p6) => func3(func2(func1(p1, p2, p3, p4, p5, p6)));
    }

    public static Func<T1, T2, T3, T4, T5, T6, T7, TEndResult> Compose<T1, T2, T3, T4, T5, T6, T7,
      TIR1, TIR2, TEndResult>(Func<T1, T2, T3, T4, T5, T6, T7, TIR1> func1, Func<TIR1, TIR2> func2,
      Func<TIR2, TEndResult> func3) {
      return (p1, p2, p3, p4, p5, p6, p7) => func3(func2(func1(p1, p2, p3, p4, p5, p6, p7)));
    }

    public static Func<T1, T2, T3, T4, T5, T6, T7, T8, TEndResult> Compose<T1, T2, T3, T4, T5, T6,
      T7, T8, TIR1, TIR2, TEndResult>(Func<T1, T2, T3, T4, T5, T6, T7, T8, TIR1> func1,
      Func<TIR1, TIR2> func2, Func<TIR2, TEndResult> func3) {
      return (p1, p2, p3, p4, p5, p6, p7, p8) =>
        func3(func2(func1(p1, p2, p3, p4, p5, p6, p7, p8)));
    }

    public static Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TEndResult> Compose<T1, T2, T3, T4, T5,
      T6, T7, T8, T9, TIR1, TIR2, TEndResult>(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TIR1> func1,
      Func<TIR1, TIR2> func2, Func<TIR2, TEndResult> func3) {
      return (p1, p2, p3, p4, p5, p6, p7, p8, p9) =>
        func3(func2(func1(p1, p2, p3, p4, p5, p6, p7, p8, p9)));
    }
    ...
    public static Func<TSource, TEndResult> Compose<TSource, TIR1, TIR2, TIR3, TEndResult>(
      Func<TSource, TIR1> func1, Func<TIR1, TIR2> func2, Func<TIR2, TIR3> func3,
    ...
    public static Func<T1, T2, TEndResult> Compose<T1, T2, TIR1, TIR2, TIR3, TEndResult>(
      Func<T1, T2, TIR1> func1, Func<TIR1, TIR2> func2, Func<TIR2, TIR3> func3,
      Func<TIR3, TEndResult> func4) {
    ...
    public static Func<T1, T2, T3, TEndResult> Compose<T1, T2, T3, TIR1, TIR2, TIR3, TEndResult>(
      Func<T1, T2, T3, TIR1> func1, Func<TIR1, TIR2> func2, Func<TIR2, TIR3> func3,
      Func<TIR3, TEndResult> func4) {
      return (p1, p2, p3) => func4(func3(func2(func1(p1, p2, p3))));
    }

    public static Func<T1, T2, T3, T4, TEndResult>
      Compose<T1, T2, T3, T4, TIR1, TIR2, TIR3, TEndResult>(Func<T1, T2, T3, T4, TIR1> func1,
        Func<TIR1, TIR2> func2, Func<TIR2, TIR3> func3, Func<TIR3, TEndResult> func4) {
      return (p1, p2, p3, p4) => func4(func3(func2(func1(p1, p2, p3, p4))));
    }

    public static Func<T1, T2, T3, T4, T5, TEndResult>
      Compose<T1, T2, T3, T4, T5, TIR1, TIR2, TIR3, TEndResult>(
        Func<T1, T2, T3, T4, T5, TIR1> func1, Func<TIR1, TIR2> func2, Func<TIR2, TIR3> func3,
        Func<TIR3, TEndResult> func4) {
    ...
    public static Func<T1, T2, T3, T4, T5, T6, TEndResult>
      Compose<T1, T2, T3, T4, T5, T6, TIR1, TIR2, TIR3, TEndResult>(
        Func<T1, T2, T3, T4, T5, T6, TIR1> func1, Func<TIR1, TIR2> func2, Func<TIR2, TIR3> func3,
        Func<TIR3, TEndResult> func4) {
      return (p1, p2, p3, p4, p5, p6) => func4(func3(func2(func1(p1, p2, p3, p4, p5, p6))));
    }

    public static Func<T1, T2, T3, T4, T5, T6, T7, TEndResult> Compose<T1, T2, T3, T4, T5, T6, T7,
      TIR1, TIR2, TIR3, TEndResult>(Func<T1, T2, T3, T4, T5, T6, T7, TIR1> func1,
      Func<TIR1, TIR2> func2, Func<TIR2, TIR3> func3, Func<TIR3, TEndResult> func4) {
      return (p1, p2, p3, p4, p5, p6, p7) => func4(func3(func2(func1(p1, p2, p3, p4, p5, p6, p7))));
    }

    public static Func<T1, T2, T3, T4, T5, T6, T7, T8, TEndResult> Compose<T1, T2, T3, T4, T5, T6,
      T7, T8, TIR1, TIR2, TIR3, TEndResult>(Func<T1, T2, T3, T4, T5, T6, T7, T8, TIR1> func1,
      Func<TIR1, TIR2> func2, Func<TIR2, TIR3> func3, Func<TIR3, TEndResult> func4) {
      return (p1, p2, p3, p4, p5, p6, p7, p8) =>
        func4(func3(func2(func1(p1, p2, p3, p4, p5, p6, p7, p8))));
    }

    public static Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TEndResult> Compose<T1, T2, T3, T4, T5,
      T6, T7, T8, T9, TIR1, TIR2, TIR3, TEndResult>(
      Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TIR1> func1, Func<TIR1, TIR2> func2,
      Func<TIR2, TIR3> func3, Func<TIR3, TEndResult> func4) {
      return (p1, p2, p3, p4, p5, p6, p7, p8, p9) =>
    ...
    public static Func<T1, T2, T3, TEndResult>
      Compose<T1, T2, T3, TIR1, TIR2, TIR3, TIR4, TEndResult>(Func<T1, T2, T3, TIR1> func1,
        Func<TIR1, TIR2> func2, Func<TIR2, TIR3> func3, Func<TIR3, TIR4> func4,
        Func<TIR4, TEndResult> func5) {
      return (p1, p2, p3) => func5(func4(func3(func2(func1(p1, p2, p3)))));
    }

    public static Func<T1, T2, T3, T4, TEndResult>
      Compose<T1, T2, T3, T4, TIR1, TIR2, TIR3, TIR4, TEndResult>(Func<T1, T2, T3, T4, TIR1> func1,
        Func<TIR1, TIR2> func2, Func<TIR2, TIR3> func3, Func<TIR3, TIR4> func4,
        Func<TIR4, TEndResult> func5) {
    ...
    public static Func<T1, T2, T3, T4, T5, TEndResult>
      Compose<T1, T2, T3, T4, T5, TIR1, TIR2, TIR3, TIR4, TEndResult>(
        Func<T1, T2, T3, T4, T5, TIR1> func1, Func<TIR1, TIR2> func2, Func<TIR2, TIR3> func3,
        Func<TIR3, TIR4> func4, Func<TIR4, TEndResult> func5) {
      return (p1, p2, p3, p4, p5) => func5(func4(func3(func2(func1(p1, p2, p3, p4, p5)))));
    }

    public static Func<T1, T2, T3, T4, T5, T6, TEndResult> Compose<T1, T2, T3, T4, T5, T6, TIR1,
      TIR2, TIR3, TIR4, TEndResult>(Func<T1, T2, T3, T4, T5, T6, TIR1> func1,
      Func<TIR1, TIR2> func2, Func<TIR2, TIR3> func3, Func<TIR3, TIR4> func4,
      Func<TIR4, TEndResult> func5) {
    ...
    public static Func<T1, T2, T3, T4, T5, T6, T7, TEndResult> Compose<T1, T2, T3, T4, T5, T6, T7,
      TIR1, TIR2, TIR3, TIR4, TEndResult>(Func<T1, T2, T3, T4, T5, T6, T7, TIR1> func1,
      Func<TIR1, TIR2> func2, Func<TIR2, TIR3> func3, Func<TIR3, TIR4> func4,
      Func<TIR4, TEndResult> func5) {
      return (p1, p2, p3, p4, p5, p6, p7) =>
        func5(func4(func3(func2(func1(p1, p2, p3, p4, p5, p6, p7)))));
    }

    public static Func<T1, T2, T3, T4, T5, T6, T7, T8, TEndResult> Compose<T1, T2, T3, T4, T5, T6,
      T7, T8, TIR1, TIR2, TIR3, TIR4, TEndResult>(Func<T1, T2, T3, T4, T5, T6, T7, T8, TIR1> func1,
      Func<TIR1, TIR2> func2, Func<TIR2, TIR3> func3, Func<TIR3, TIR4> func4,
      Func<TIR4, TEndResult> func5) {
      return (p1, p2, p3, p4, p5, p6, p7, p8) =>
    ...
    public static Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TEndResult> Compose<T1, T2, T3, T4, T5,
      T6, T7, T8, T9, TIR1, TIR2, TIR3, TIR4, TEndResult>(
      Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TIR1> func1, Func<TIR1, TIR2> func2,
      Func<TIR2, TIR3> func3, Func<TIR3, TIR4> func4, Func<TIR4, TEndResult> func5) {
      return (p1, p2, p3, p4, p5, p6, p7, p8, p9) =>
    ...
    public static Action<T1, T2, T3, T4, T5, T6>
      Compose<T1, T2, T3, T4, T5, T6, TIntermediateResult>(
        Func<T1, T2, T3, T4, T5, T6, TIntermediateResult> func1,
    ...
    public static Action<T1, T2, T3, T4, T5, T6, T7>
      Compose<T1, T2, T3, T4, T5, T6, T7, TIntermediateResult>(
        Func<T1, T2, T3, T4, T5, T6, T7, TIntermediateResult> func1,
        Action<TIntermediateResult> action) {
    ...
    public static Action<T1, T2, T3, T4, T5, T6, T7, T8> Compose<T1, T2, T3, T4, T5, T6, T7, T8,
      TIntermediateResult>(Func<T1, T2, T3, T4, T5, T6, T7, T8, TIntermediateResult> func1,
      Action<TIntermediateResult> action) {
      return (p1, p2, p3, p4, p5, p6, p7, p8) => action(func1(p1, p2, p3, p4, p5, p6, p7, p8));
    }

    public static Action<T1, T2, T3, T4, T5, T6, T7, T8, T9> Compose<T1, T2, T3, T4, T5, T6, T7, T8,
      T9, TIntermediateResult>(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TIntermediateResult> func1,
      Action<TIntermediateResult> action) {
      return (p1, p2, p3, p4, p5, p6, p7, p8, p9) =>
        action(func1(p1, p2, p3, p4, p5, p6, p7, p8, p9));
    }
    ...
    public static Action<TSource> Compose<TSource, TIR1, TIR2>(Func<TSource, TIR1> func1,
      Func<TIR1, TIR2> func2, Action<TIR2> action) {
      return sourceParam => action(func2(func1(sourceParam)));
    }

    public static Action<T1, T2> Compose<T1, T2, TIR1, TIR2>(Func<T1, T2, TIR1> func1,
      Func<TIR1, TIR2> func2, Action<TIR2> action) {
      return (p1, p2) => action(func2(func1(p1, p2)));
    }

    public static Action<T1, T2, T3> Compose<T1, T2, T3, TIR1, TIR2>(Func<T1, T2, T3, TIR1> func1,
      Func<TIR1, TIR2> func2, Action<TIR2> action) {
    ...
    public static Action<T1, T2, T3, T4, T5, T6, T7>
      Compose<T1, T2, T3, T4, T5, T6, T7, TIR1, TIR2>(Func<T1, T2, T3, T4, T5, T6, T7, TIR1> func1,
        Func<TIR1, TIR2> func2, Action<TIR2> action) {
      return (p1, p2, p3, p4, p5, p6, p7) => action(func2(func1(p1, p2, p3, p4, p5, p6, p7)));
    }

    public static Action<T1, T2, T3, T4, T5, T6, T7, T8>
      Compose<T1, T2, T3, T4, T5, T6, T7, T8, TIR1, TIR2>(
        Func<T1, T2, T3, T4, T5, T6, T7, T8, TIR1> func1, Func<TIR1, TIR2> func2,
        Action<TIR2> action) {
      return (p1, p2, p3, p4, p5, p6, p7, p8) =>
        action(func2(func1(p1, p2, p3, p4, p5, p6, p7, p8)));
    }
    ...
    public static Action<T1, T2, T3, T4, T5, T6, T7, T8, T9>
      Compose<T1, T2, T3, T4, T5, T6, T7, T8, T9, TIR1, TIR2>(
        ...
        Action<TIR2> action) {
      return (p1, p2, p3, p4, p5, p6, p7, p8, p9) =>
        action(func2(func1(p1, p2, p3, p4, p5, p6, p7, p8, p9)));
    }
    ...
    public static Action<TSource> Compose<TSource, TIR1, TIR2, TIR3>(Func<TSource, TIR1> func1,
      Func<TIR1, TIR2> func2, Func<TIR2, TIR3> func3, Action<TIR3> action) {
      return sourceParam => action(func3(func2(func1(sourceParam))));
    }

    public static Action<T1, T2> Compose<T1, T2, TIR1, TIR2, TIR3>(Func<T1, T2, TIR1> func1,
      Func<TIR1, TIR2> func2, Func<TIR2, TIR3> func3, Action<TIR3> action) {
    ...
    public static Action<T1, T2, T3, T4> Compose<T1, T2, T3, T4, TIR1, TIR2, TIR3>(
      Func<T1, T2, T3, T4, TIR1> func1, Func<TIR1, TIR2> func2, Func<TIR2, TIR3> func3,
      Action<TIR3> action) {
    ...
    public static Action<T1, T2, T3, T4, T5, T6, T7>
      Compose<T1, T2, T3, T4, T5, T6, T7, TIR1, TIR2, TIR3>(
        Func<T1, T2, T3, T4, T5, T6, T7, TIR1> func1, Func<TIR1, TIR2> func2,
        Func<TIR2, TIR3> func3, Action<TIR3> action) {
      return (p1, p2, p3, p4, p5, p6, p7) =>
        action(func3(func2(func1(p1, p2, p3, p4, p5, p6, p7))));
    }

    public static Action<T1, T2, T3, T4, T5, T6, T7, T8>
      Compose<T1, T2, T3, T4, T5, T6, T7, T8, TIR1, TIR2, TIR3>(
        Func<T1, T2, T3, T4, T5, T6, T7, T8, TIR1> func1, Func<TIR1, TIR2> func2,
        Func<TIR2, TIR3> func3, Action<TIR3> action) {
      return (p1, p2, p3, p4, p5, p6, p7, p8) =>
        action(func3(func2(func1(p1, p2, p3, p4, p5, p6, p7, p8))));
    }

    public static Action<T1, T2, T3, T4, T5, T6, T7, T8, T9>
      Compose<T1, T2, T3, T4, T5, T6, T7, T8, T9, TIR1, TIR2, TIR3>(
        Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TIR1> func1, Func<TIR1, TIR2> func2,
        Func<TIR2, TIR3> func3, Action<TIR3> action) {
      return (p1, p2, p3, p4, p5, p6, p7, p8, p9) =>
    ...
    public static Action<T1, T2> Compose<T1, T2, TIR1, TIR2, TIR3, TIR4>(Func<T1, T2, TIR1> func1,
      Func<TIR1, TIR2> func2, Func<TIR2, TIR3> func3, Func<TIR3, TIR4> func4, Action<TIR4> action) {
    ...
    public static Action<T1, T2, T3, T4, T5, T6>
      Compose<T1, T2, T3, T4, T5, T6, TIR1, TIR2, TIR3, TIR4>(
        Func<T1, T2, T3, T4, T5, T6, TIR1> func1, Func<TIR1, TIR2> func2, Func<TIR2, TIR3> func3,
        Func<TIR3, TIR4> func4, Action<TIR4> action) {
    ...
    public static Action<T1, T2, T3, T4, T5, T6, T7>
      Compose<T1, T2, T3, T4, T5, T6, T7, TIR1, TIR2, TIR3, TIR4>(
        Func<T1, T2, T3, T4, T5, T6, T7, TIR1> func1, Func<TIR1, TIR2> func2,
        Func<TIR2, TIR3> func3, Func<TIR3, TIR4> func4, Action<TIR4> action) {
      return (p1, p2, p3, p4, p5, p6, p7) =>
        action(func4(func3(func2(func1(p1, p2, p3, p4, p5, p6, p7)))));
    }
    ...
    public static Action<T1, T2, T3, T4, T5, T6, T7, T8, T9> Compose<T1, T2, T3, T4, T5, T6, T7, T8,
      T9, TIR1, TIR2, TIR3, TIR4>(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TIR1> func1,
      Func<TIR1, TIR2> func2, Func<TIR2, TIR3> func3, Func<TIR3, TIR4> func4, Action<TIR4> action) {
      return (p1, p2, p3, p4, p5, p6, p7, p8, p9) =>
