...
namespace FCSlib {
  public static partial class Functional {
    ...
    public static Func<R, Func<IEnumerable<T>, R>> FoldL<T, R>(Func<R, T, R> accumulator) => startVal => list => FoldL(accumulator, startVal, list);
    ...
    public static Func<IEnumerable<T>, T> FoldL1<T>(Func<T, T, T> accumulator) => list => FoldL1(accumulator, list);
    ...
    public static Func<R, Func<IEnumerable<T>, R>> FoldR<T, R>(Func<T, R, R> accumulator) => startVal => list => FoldR(accumulator, startVal, list);
    ...
    public static Func<IEnumerable<T>, T> FoldR1<T>(Func<T, T, T> accumulator) => list => FoldR1(accumulator, list);
  }
}
