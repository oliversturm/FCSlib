...
namespace FCSlib {
  public static partial class Functional {
    ...
    public static RES Either<R, L, RES>(Func<R?, RES> rightHandler, Func<L?, RES> leftHandler,
      Either e) => e switch {
    ...
    public static Func<Func<L?, RES>, Func<Either, RES>>
      Either<R, L, RES>(Func<R?, RES> rightHandler) =>
      leftHandler => e => Either(rightHandler, leftHandler, e);

    public static Either Tag<T>(Predicate<T> predicate, T value) =>
